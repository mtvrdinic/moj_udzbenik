...
<main>
		...
		<div id="carouselExampleIndicators" class="carousel slide bg-light" data-ride="carousel">
		  	...
		  	<div class="carousel-inner">
		    	<div class="carousel-item active">
		      		<img class="d-block w-100 custom-carousel-image" src="img/1200x520.1.blur.png" alt="First slide">
		    	...
		    	<div class="carousel-item">
		      		<img class="d-block w-100 custom-carousel-image" src="img/1200x520.2.png" alt="Second slide">
			      	<div class="carousel-caption">
		   				<h1>Nemate popis?</h1>
		    	...
		    	<div class="carousel-item">
			      	<img class="d-block w-100 custom-carousel-image" src="img/1200x520.3.blur.png" alt="Third slide">
			      	<div class="carousel-caption">
		   				<h1>SMARTBUY</h1>
		    			<h2>Sve potrebne knjige kroz jedan klik!</h2>
			    	</div>
		    	</div>
		  	</div>
	  	...
	  	<div class="d-flex justify-content-center">
	  		<form class="form-inline" action="showadds.php" method="get">
				...
				<button type="submit" class="btn btn-primary mb-2" name="schoolsearch-submit">
					<i class="fas fa-search"></i> <span id="trazi-index"> Traži </span>
				</button>
			</form>
		</div>
	</div>
	...
	<div class="jumbotron jumbotron-fluid bg-primary" id="jumbo2">
		...
		<p class="text-center">		  
		  	<button 	class="btn btn-outline-light" type="button" data-toggle="collapse" 
		  				data-target="#collapseRegion" aria-expanded="false" aria-controls="collapseRegion">
		    		Odaberi županiju, školu i razred <i class="fas fa-chevron-down mx-1"></i>
		  	</button>
		</p>
		  ...
		  <div class="card card-body bg-primary">
		    <div class="d-flex justify-content-center">
		  		<form class="form-inline" action="showadds.php" method="get">
				  	...
				  	<select class="custom-select my-2 mr-sm-2 text-center" id="regionpicker" required>
				...
				-->
					...
					<label class="my-1 mr-2 sr-only" for="regionSchoolList">&nbsp; Odaberi školu</label>
				  	<select class="custom-select mx-2 my-1 mr-sm-2" id="regionSchoolList" name="schoolsearch" style="max-width: 200px; font-size: 12px">
	...
	<div class="jumbotron jumbotron-fluid bg-dark">
	  	...
	  	<p class="text-center">
		  	<button 	class="btn btn-outline-light" type="button" data-toggle="collapse" 
		  				data-target="#collapseBook" aria-expanded="false" aria-controls="collapseBook">
		    	Pretraži oglase po knjizi <i class="fas fa-chevron-down mx-1"></i>
		  	</button>
		</p>
